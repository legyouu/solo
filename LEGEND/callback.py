...
from LEGEND.Data import get_dev, get_group, get_channel, get_dev_name
...
Powered By [{OWNER_NAME}]""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("Donate", url=f"https://t.me/UR_ML")
                ],
                [
...
💡 **If you have a follow-up questions about this bot, you can tell it on my support chat here: @UR_ML**
